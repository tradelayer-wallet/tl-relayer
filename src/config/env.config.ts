...
export const envConfig: {
    ...
    SERVER_PORT: parseInt(process.env.SERVER_PORT || '8002', 10), // Default to 3000 if not set
    SOCKET_PORT: parseInt(process.env.SOCKET_PORT || '8003', 10), // Default to 3001 if not set
